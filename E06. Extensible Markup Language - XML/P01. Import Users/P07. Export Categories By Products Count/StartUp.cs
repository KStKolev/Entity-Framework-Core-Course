...
namespace ProductShop
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string productsResult = GetCategoriesByProductsCount(context);
            File.WriteAllText(@"D:\\Programming\\Entity_Framework\\XML_Processing_Exercise\\ProductShop\\ProductShop\\Results\\categories-by-products.xml", productsResult);
        }
