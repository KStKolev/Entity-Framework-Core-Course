...
namespace ProductShop
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string productsResult = GetProductsInRange(context);
            File.WriteAllText(@"D:\\Programming\\Entity_Framework\\XML_Processing_Exercise\\ProductShop\\ProductShop\\Results\\products-in-range.xml", productsResult);
        }
        ...
        public static string GetSoldProducts(ProductShopContext context) 
        {
            ...
            var usersWithSoldItems = context.Users
                ...
                .Select(u => new ExportUserWithProductDTO() 
                {
                    ...
                    LastName = u.LastName,
                    ProductsSold = u.ProductsBought.Select(pb => new ExportBoughtProductDTO()
                    {
                        Name = pb.Name,
                        Price = pb.Price
                    })
