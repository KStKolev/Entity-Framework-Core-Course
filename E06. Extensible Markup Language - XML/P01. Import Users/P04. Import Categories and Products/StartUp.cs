...
namespace ProductShop
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string filePath = "D:\\Programming\\Entity_Framework\\XML_Processing_Exercise\\ProductShop\\ProductShop\\Datasets\\categories-products.xml";
            var xmlReadFile = File.ReadAllText(filePath);
            Console.WriteLine(ImportCategoryProducts(context, xmlReadFile));
        }
