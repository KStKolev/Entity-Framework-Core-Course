...
namespace CarDealer
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string fileName = @"D:\Programming\Entity_Framework\XML_Processing_Exercise\CarDealer\CarDealer\Results\cars-and-parts.xml";
            File.WriteAllText(fileName, GetCarsWithTheirListOfParts(context));
        }
