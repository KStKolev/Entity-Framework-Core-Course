...
namespace CarDealer
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string fileName = @"D:\Programming\Entity_Framework\XML_Processing_Exercise\CarDealer\CarDealer\Results\bmw-cars.xml";
            File.WriteAllText(fileName, GetCarsFromMakeBmw(context));
        }
