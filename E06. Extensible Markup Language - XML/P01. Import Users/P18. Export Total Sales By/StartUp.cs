...
namespace CarDealer
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string fileName = @"D:\Programming\Entity_Framework\XML_Processing_Exercise\CarDealer\CarDealer\Results\customers-total-sales.xml";
            File.WriteAllText(fileName, GetTotalSalesByCustomer(context));
        }
