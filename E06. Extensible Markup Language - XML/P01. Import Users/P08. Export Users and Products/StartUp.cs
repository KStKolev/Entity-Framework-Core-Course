...
namespace ProductShop
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string productsResult = GetUsersWithProducts(context);
            File.WriteAllText(@"D:\\Programming\\Entity_Framework\\XML_Processing_Exercise\\ProductShop\\ProductShop\\Results\\users-and-products.xml", productsResult);
        }
        ...
        public static string GetUsersWithProducts(ProductShopContext context) 
        {
            var users = context.Users
                ...
                .Select(u => new ExportUsersAndProductsDTO()
                {
                    ...
                    LastName = u.LastName,
                    Age = u.Age,
                    ExportedProducts = new SoldProductsDTO()
                    {
            ...
            var countedUsers = new ExportUserDTO()
            {
                Count = users.Length,
                Users = users
                 .Take(10)
            ...
            return Serializer<ExportUserDTO>(countedUsers, "Users");
        }
    }
}