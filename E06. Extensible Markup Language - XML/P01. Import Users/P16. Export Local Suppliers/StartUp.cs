...
namespace CarDealer
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string fileName = @"D:\Programming\Entity_Framework\XML_Processing_Exercise\CarDealer\CarDealer\Results\local-suppliers.xml";
            File.WriteAllText(fileName, GetLocalSuppliers(context));
        }
