...
namespace CarDealer
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string fileName = @"D:\Programming\Entity_Framework\XML_Processing_Exercise\CarDealer\CarDealer\Results\sales-discounts.xml";
            File.WriteAllText(fileName, GetSalesWithAppliedDiscount(context));
        }
        ...
        public static string GetCarsFromMakeBmw(CarDealerContext context) 
        {
            ...
            return Serialize<ExportCarsFromMakeBMWDTO[]>(cars, new XmlRootAttribute("cars"));
        }
        ...
        public static string GetLocalSuppliers(CarDealerContext context) 
        {
            ...
            return Serialize<ExportLocalSuppliersDTO[]>(suppliers, new XmlRootAttribute("suppliers"));
        }
        ...
        public static string GetCarsWithTheirListOfParts(CarDealerContext context)
        {
            var cars = context.Cars
                ...
                .Select(c => new ExportCarsWithTheirListOfPartsDTO()
                {
                    ...
                    Model = c.Model,
                    TraveledDistance = c.TraveledDistance,
                    Parts = new ExportListOfPartsDTO()
                    {
                        Parts = c.PartsCars.Select(pc => new ListOfParts()
                        {
                            Name = pc.Part.Name,
                            Price = pc.Part.Price,
                        })
            ...
            return Serialize(cars, new XmlRootAttribute("cars"));
        }
        ...
        public static string GetTotalSalesByCustomer(CarDealerContext context) 
        {
            ...
            .Select(s => new ExportTotalSalesByCustomerDTO()
            {
                ...
                SpentMoney = s.moneyCars.Sum()
            })
            .OrderByDescending(o => o.SpentMoney)
            .ToArray();

            return Serialize<ExportTotalSalesByCustomerDTO[]>(output, new XmlRootAttribute("customers"));
        }
        ...
        public static string GetSalesWithAppliedDiscount(CarDealerContext context) 
        {
            ...
            ExportSalesWithAppliedDiscountDTO[]? output = sales.Select(s => new ExportSalesWithAppliedDiscountDTO()
            {
                Car = s.Car,
                Discount = (int) s.Discount,
                CustomerName = s.CustomerName,
                Price = decimal.Parse(s.Price),
                PriceDiscount = Math.Round(decimal.Parse(s.Price) - (decimal.Parse(s.Price) * s.Discount / 100),4)
            }).ToArray();

            return Serialize<ExportSalesWithAppliedDiscountDTO[]>(output, new XmlRootAttribute("sales"));
        }
    }
}