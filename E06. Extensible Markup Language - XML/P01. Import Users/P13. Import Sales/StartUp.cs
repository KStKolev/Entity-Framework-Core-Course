...
namespace CarDealer
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string xmlFile = File.ReadAllText(@"D:\Programming\Entity_Framework\XML_Processing_Exercise\CarDealer\CarDealer\Datasets\sales.xml");
            Console.WriteLine(ImportSales(context, xmlFile));
        }
