namespace BookShop
{
    ...
    public class StartUp
    {
        ...
        public static string GetMostRecentBooks(BookShopContext context) 
        {
            ...
            var recentBooks = context.Categories.Select(c => new
            {
                c.Name,
            ...
            {
                result.AppendLine($"--{recentBook.Name}");
                foreach (var book in recentBook.RecentBooks)
                {
                    result.AppendLine($"{book.Title} ({book.BookYear})");
                }
            }
        ...
        {
            var removedBooks = context.Books.Where(b => b.Copies < 4200);
            int countOfDeletedBooks = removedBooks.Count();
